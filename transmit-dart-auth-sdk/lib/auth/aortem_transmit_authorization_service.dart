import 'dart:convert';
import 'package:http/http.dart' as http; // Ensure the correct HTTP package is used
...
class AortemTransmitAuthorization {
  ...
  AortemTransmitAuthorization({required this.apiKey, this.baseUrl = 'https://api.transmitsecurity.com'}) {
    if (apiKey.isEmpty) {
  ...
  Future<Map<String, dynamic>> authorize(String accessToken, {List<String>? requiredScopes}) async {
